# Şablon — Announce trailer (`media`) **[K]**

> **Sınıf:** `media` — makalenin birebir örnek verdiği çıktı türü.
> **Çıktı:** video 16:9, ~12 sn · **Hedef:** `art-source/media/` · **Registry:** ASSET-030
> **Oyuna girmez** — pazarlama teslimi. **[A]** Araştırmanın uyarısı: üretilmiş klip gerçek zamanlı render değildir; trailer'ın görsel barını oyunun barı sanmak projeyi batıran klasik hata.
> Ortak bloklar: `_anatomy.md`.

## Dramatik yay

Trailer'ın yayı = **unutuşun yükselişi ve teslimle geri çekilmesi**. Sahne güzelleşirken okunabilirliğini kaybeder, HUD sırayla siler, gemi son direnen şey olur (`art-bible.md` §4). Ekran **karartılmaz** — pus beyazdır.

## Prompt

```text
Using Higgsfield, generate this as a video — 16:9, ~12 seconds, high quality. Pick the best model for stylized-cartoon next-gen game graphics (bright, glossy stylized 3D look — soft-shaded, rounded, colorful, NOT photoreal).
...
Look: sun-drenched Aegean island at golden hour — turquoise shallows shading into lapis blue, white foam lines, golden sand, white-and-pink lotus that looks faintly lit from within, broad green lily pads, sun-bleached wood, distant hazy blue-grey hills, olive and cypress silhouettes. COOL BLUE shadows (never black), turquoise bounce off the water, soft bloom, warm color grade, light blue-white distance haze, soft-shaded stylized surfaces with low surface noise. Original characters and world only — no logos, no brand marks, no real game titles, no on-screen text beyond the game HUD.
```

## Varyasyon

2 üretim — biri kamera daha yakın, biri daha geniş. Kazanan `art-source/media/`, kaybeden `art-source/raw/` altında kalır.

## Kabul kriteri **[P]**

- [ ] Üç beat okunuyor: **topla → unut → teslim et ve kendine gel**
- [ ] Pusun yükselişi ve teslimde geri çekilişi görünür (art bible §4)
- [ ] Gemi pus içinde en okunur şey olarak kalmış
- [ ] Kamera omuz-arkasında; sinematik uçuşa geçmemiş
- [ ] Gölgeler mavi, palet §2 aralığında
- [ ] Fotogerçekçi değil, HUD dışında yazı yok, marka izi yok **[K]**
