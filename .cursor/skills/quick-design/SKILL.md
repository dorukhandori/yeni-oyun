...
**Quality layer:** For a new small system or addition (not a number-only tuning),
run `scenario-engine` (`feature` or `logic`) first — `.claude/skills/scenario-engine/SKILL.md`.
It does not replace this skill.
