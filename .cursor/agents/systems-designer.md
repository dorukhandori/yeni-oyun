...
**Quality layer:** For care/watering/calendar **docs**, run `scenario-engine`
mode `logic` first. Do not edit `PotView` or NPK mix C# from this role unless
sahip assigned that work elsewhere.
