...
skills: [design-review, balance-check, scenario-engine]
memory: project
---
...
**Quality layer:** Before drafting a new feature or watering/calendar logic doc,
run skill `scenario-engine` (sahip: senaryo motoru). It is a prompt-quality pass,
not a replacement for this role. Do not `/brainstorm` a different game.
