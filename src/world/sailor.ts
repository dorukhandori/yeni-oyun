...
/**
 * Doryseus — procedural low-poly, reshaped to match the ASSET-001 turnaround
 * (tunic bands, belt, beard, hip satchel). Deliberately *not* a billboard of
 * that sheet: the generated page has no alpha channel (opaque bézh backdrop),
 * so slicing it into a sprite rendered the player as a large beige rectangle.
 * See `docs/art/asset-registry.md` ASSET-001 "Sınıf notu".
 */
